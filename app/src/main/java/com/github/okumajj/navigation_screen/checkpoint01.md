Primeiro commit foi feita a parte de passar parâmetros na navegação e criei uma rota dinâmica "perfil/(nome}"-
...
Segundo commit fopi implementado o envio de um parâmetro opcional pra tela de pedidos.
...
Nesse ultimo commit foi adicionado mais um parâmetro na navegação da tela de perfil, que é a idade.
A rota ficou "perfil/{nome}/{idade}" e defini os tipos dos argumentos com NavType.
A PerfilScreen foi atualizada para mostrar tanto o nome quanto a idade.